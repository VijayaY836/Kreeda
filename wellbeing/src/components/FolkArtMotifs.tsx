...
export const SunMedallionIcon: React.FC<MotifProps> = ({ size = 24, className = '', color = '#0E5C58' }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
    <circle cx="16" cy="16" r="12" fill="#F6ECD2" stroke="#5C140F" strokeWidth="2.5" />
    <circle cx="16" cy="16" r="5.5" fill={color} stroke="#5C140F" strokeWidth="1.8" />
    <path d="M16 3v4M16 25v4M3 16h4M25 16h4M6.5 6.5l2.8 2.8M22.7 22.7l2.8 2.8M25.5 6.5l-2.8 2.8M9.3 22.7l-2.8 2.8" stroke="#5C140F" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);

/* Mace/mudgar silhouette for Vyayam — the akhada strength-training tradition. */
export const MaceIcon: React.FC<MotifProps> = ({ size = 24, className = '', color = '#D8401F' }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
    <circle cx="16" cy="16" r="12" fill="#F6ECD2" stroke="#5C140F" strokeWidth="2.5" />
    <path d="M16 8v13" stroke="#5C140F" strokeWidth="2.2" strokeLinecap="round" />
    <circle cx="16" cy="9" r="3.6" fill={color} stroke="#5C140F" strokeWidth="1.8" />
    <path d="M12 22h8" stroke="#5C140F" strokeWidth="2.2" strokeLinecap="round" />
  </svg>
);

/* Om-derived spiral for Dhyana — a settled, inward-turning mind. */
export const OmSpiralIcon: React.FC<MotifProps> = ({ size = 24, className = '', color = '#3E6E9E' }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
    <circle cx="16" cy="16" r="12" fill="#F6ECD2" stroke="#5C140F" strokeWidth="2.5" />
    <circle cx="16" cy="16" r="7" fill="none" stroke={color} strokeWidth="2.2" />
    <circle cx="16" cy="16" r="2.6" fill={color} stroke="#5C140F" strokeWidth="1.4" />
    <path d="M16 9v-2M16 25v-2M9 16H7M25 16h-2" stroke="#5C140F" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
